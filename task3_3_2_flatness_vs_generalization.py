# -*- coding: utf-8 -*-
"""Task3_3_2_Flatness_vs_Generalization.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1HlK-sFdsinSgIU2BdiZqT1czrMGwYCJP
"""
...
# Model 1 - 2 Hidden layer / 49240 Parameters
...
# Model 2 - 2 Hidden layer / 49240 Parameters
...
# Model 3 - 2 Hidden layer / 49240 Parameters
...
# Model 4 - 2 Hidden layer / 49240 Parameters
...
# Model 5 - 2 Hidden layer / 49240 Parameters
...
ax2 = ax1.twinx()
ax1.plot(batchSizes, trainAccList, 'r', label='Train')
ax1.plot(batchSizes, testAccList, 'r--', label='Test')
...
fig, ax1 = plt.subplots()
ax2 = ax1.twinx()
ax1.plot(batchSizes, trainCostList, 'r', label='Train')
ax1.plot(batchSizes, testCostList, 'r--', label='Test')
ax2.plot(batchSizes, sensitivityList, 'b', label='Sensitivity')
